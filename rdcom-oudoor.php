    ...
    <div class="container">
        <div class="breadcrumb-content">
            <ul>
                ...
                <li class="active">RDCOM Cat 6 Outdoor Cable</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/RDCOM-OUTDOOR.webp"
                                data-gall="myGallery">
                                <img src="images/product/small-size/RDCOM-OUTDOOR.webp" alt="product image" />
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-7 col-md-6">
                <div class="product-details-view-content pt-60">
                    <div class="product-info">
                        <h4>
                            <a class="product_name">RDCOM Cat 6 Outdoor Cable</a>
                        </h4>
                        ...
                        <div class="product-desc">
                            <p>
                                <span>
                                    <h4><b>Features: RDCOM Cat 6 Outdoor Cable</b></h4>
                                    <ul>
                                        <li><b>High-Speed Performance:</b> Supports Gigabit Ethernet, ensuring efficient
                                            and reliable data transmission.</li>
                                        <li><b>Enhanced Shielding:</b> Features advanced shielding to protect against
                                            moisture, UV rays, and extreme temperatures, making it ideal for outdoor
                                            installations.</li>
                                        <li><b>Durable Construction:</b> Designed to withstand harsh environmental
                                            conditions, ensuring longevity and consistent performance.</li>
                                        <li><b>Length:</b> Available in 305 meters (1000 feet) per roll, suitable for
                                            extensive cabling requirements.</li>
                                        <li><b>Applications:</b> Ideal for connecting outdoor devices like security
                                            cameras and routers.</li>
                                    </ul>
                                </span>
                            </p>
                        </div>
