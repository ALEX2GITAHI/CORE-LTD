    ...
    <div class="container-fluid">
        <div class="breadcrumb-content">
            <ul>
                ...
                <li class="active">Drop Cable 1KM 2 Core</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/drop 1km.webp"
                                data-gall="myGallery">
                                <img src="images/product/small-size/drop 1km.webp" alt="product image" />
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-7 col-md-6">
                <div class="product-details-view-content pt-60">
                    <div class="product-info">
                        <h4>
                            <a class="product_name">Drop Cable 1KM 2 Core</a>
                        </h4>
                        ...
                        <div class="price-box">
                            <span class="new-price">Ksh. 5,800</span>
                        </div>
                        <div class="product-desc">
                            <div style="overflow-x:auto;">
                                <h4><b>Features: Drop Cable 1KM 2 Core</b></h4>
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding:10px; border:1px solid #ddd;">Ideal for Fiber-to-the-Home
                                                (FTTH), last-mile connectivity, and outdoor installations.</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="padding:10px; border:1px solid #ddd;">Reinforced with steel wire
                                                / FRP for added durability and tensile strength.</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <!-- Hidden Rows -->
                                    <tbody id="more-drop-cable" style="display: none;">
                                        <tr>
                                            ...
                                            <td style="padding:10px; border:1px solid #ddd;">UV-resistant LSZH / PE
                                                sheath suitable for outdoor use.</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="padding:10px; border:1px solid #ddd;">Supports aerial, duct, and
                                                direct wall installations.</td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;"><b>Weather Resistance</b>
                                            </td>
                                            <td style="padding:10px; border:1px solid #ddd;">Designed to withstand harsh
                                                environmental conditions including sun, rain, and wind.</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="padding:10px; border:1px solid #ddd;">Ensures stable and
                                                efficient data transmission over long distances.</td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;"><b>Lightweight &
                                                    Flexible</b></td>
                                            <td style="padding:10px; border:1px solid #ddd;">Easy to handle, route, and
                                                install in residential and commercial setups.</td>
                                        </tr>
                                    </tbody>
                                    </tbody>
                                </table>
                                ...
                                <div style="text-align:center; margin-top:10px;">
                                    <button onclick="toggleDropCable()"
                            ...
                            <!-- Script -->
                            <script>
                                function toggleDropCable() {
                                    var hiddenRows = document.getElementById("more-drop-cable");
                                    var button = document.getElementById("dropCableBtn");
