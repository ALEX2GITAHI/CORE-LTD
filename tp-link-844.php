      ...
      <div class="col-lg-5 col-md-6">
        ...
        <div class="product-details-left">
          <div class="product-details-images slider-navigation-1">
            <div class="lg-image">
              <a
                ...
                href="images/product/small-size/tp link844 front.jpg"
                data-gall="myGallery">
                <img
            ...
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/tplink 844 box.jpg"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/tplink 844 box.jpg"
                  alt="product image" />
              </a>
            </div>
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/tplik8441.jpg"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/tplik8441.jpg"
                  alt="product image" />
              </a>
            </div>  
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/tplink 844 side.jpg"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/tplink 844 side.jpg"
                  alt="product image" />
              </a>
            </div>           
          </div>
          <div class="product-details-thumbs slider-thumbs-1">
            ...
            <div class="sm-image">
              <img
              src="images/product/small-size/tploink 844 up.jpg"
              alt="product image thumb" />
            </div>     
            <div class="sm-image">
              <img
              ...
              <div class="single-product-wrap">
                <div class="product-image">
                  <a href="tp-link-840.php">
                    <img
                      src="images/product/small-size/tplink side.jpeg"
