    ...
    <div class="container">
        <div class="breadcrumb-content">
            <ul>
                ...
                <li class="active">TP-Link 840N Router</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/tp link844 front.jpg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/tp link844 front.jpg" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/tplink 844 box.jpg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/tplink 844 box.jpg" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/tplik8441.jpg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/tplik8441.jpg" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/tplink 844 side.jpg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/tplink 844 side.jpg" alt="product image" />
                            </a>
                        </div>
                    </div>
                    <div class="product-details-thumbs slider-thumbs-1">
                        <div class="sm-image">
                            <img src="images/product/small-size/tp link844 front.jpg" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/tplink 844 box.jpg" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/tplik8441.jpg" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/tploink 844 up.jpg" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/tplink 844 side.jpg" alt="product image thumb" />
                        </div>
                    </div>
                </div>
                <!--// Product Details Left -->
            ...
            <div class="col-lg-7 col-md-6">
                <div class="product-details-view-content pt-60">
                    <div class="product-info">
                        <h4>
                            <a class="product_name">TP-Link 840N Router</a>
                        </h4>
                        <span class="product-details-ref">Reference: TP</span>
                        ...
                        <div class="single-product-wrap">
                            <div class="product-image">
                                <a href="tp-link-840.php">
                                    <img src="images/product/small-size/tplink side.jpeg" alt="Li's Product Image" />
                                </a>
