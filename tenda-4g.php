      ...
      <div class="col-lg-5 col-md-6">
        ...
        <div class="product-details-left">
          <div class="product-details-images slider-navigation-1">
            <div class="lg-image">
              <a
                ...
                href="images/product/small-size/tenda 4g front.png"
                data-gall="myGallery">
                <img
            ...
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/tenda 4g side.jpg"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/tenda 4g side.jpg"
                  alt="product image" />
              </a>
            </div>
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/tenda 4g up.png"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/tenda 4g up.png"
                  alt="product image" />
              </a>
            </div>  
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/tenda 4g back.jpg"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/tenda 4g back.jpg"
                  alt="product image" />
              </a>
            </div>           
          </div>
          <div class="product-details-thumbs slider-thumbs-1">
            ...
            <div class="sm-image">
              <img
              src="images/product/small-size/tenda 4g box.jpg"
              alt="product image thumb" />
            </div> 
          </div>
        </div>
      ...
      <div class="col-lg-7 col-md-6">
        <div class="product-details-view-content pt-60">
          <div class="product-info">
            <h3>Tenda 4G03 N300 Wi-Fi 4G LTE Router.</h3>
