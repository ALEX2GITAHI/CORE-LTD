    ...
    <div class="container-fluid">
        <div class="breadcrumb-content">
            <ul>
                ...
                <li class="active">PowerBeam M5</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/power-beam-up.webp"
                                data-gall="myGallery">
                                <img src="images/product/small-size/power-beam-up.webp" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/power-beam-all.jpeg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/power-beam-all.jpeg" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/power-beam-front.jpg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/power-beam-front.jpg" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/power-beam-up.webp"
                    ...
                    <div class="product-details-thumbs slider-thumbs-1">
                        <div class="sm-image">
                            <img src="images/product/small-size/power-beam-up.webp" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/power-beam-all.jpeg" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/power-beam-front.jpg" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/power-beam-up.webp" alt="product image thumb" />
                        </div>
            ...
            <div class="col-lg-7 col-md-6">
                <div class="product-details-view-content pt-60">
                    <div class="product-info">
                        <h4>
                            <a class="product_name">Ubiquiti PowerBeam M5</a>
                        </h4>
                        ...
                        <div class="product-desc">
                            ...
                            <div style="overflow-x:auto;">
                                ...
                                <table
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;"><b>High-Speed
                                                    Performance</b></td>
                                            <td style="padding:10px; border:1px solid #ddd;">Delivers up to 100+ Mbps
                                                throughput on the 5 GHz frequency band for point-to-point or CPE
                                                connections.</td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;"><b>Long-Distance
                                                    Connectivity</b></td>
                                            <td style="padding:10px; border:1px solid #ddd;">Supports wireless links up
                                                to 30+ km with focused beam technology for reliable outdoor coverage.
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;"><b>Directional Antenna
                                                    Design</b></td>
                                            <td style="padding:10px; border:1px solid #ddd;">Integrated 23 dBi
                                                directional antenna provides strong signal quality with minimal
                                                interference.</td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;"><b>Lightweight &
                                                    Compact</b></td>
                                            <td style="padding:10px; border:1px solid #ddd;">Weighs less than 1 kg with
                                                a sleek, highly efficient design—ideal for quick installations.</td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;"><b>AirOS & AirMax
                                                    Technology</b></td>
                                            <td style="padding:10px; border:1px solid #ddd;">Features Ubiquiti’s AirOS
                                                for intuitive device management and AirMax TDMA protocol for scalable,
                                                low-latency networks.</td>
                                        </tr>

                                        <!-- Hidden Rows -->
                                    <tbody id="more-features" style="display: none;">
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;"><b>Robust Outdoor Build</b>
                                            </td>
                                            <td style="padding:10px; border:1px solid #ddd;">Designed for harsh
                                                environments with UV-stabilized plastic and wind resistance up to 200
                                                km/h.</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="padding:10px; border:1px solid #ddd;">Powered via passive PoE
                                                adapter (24V), reducing cable clutter and simplifying deployment.</td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;"><b>Easy Installation</b>
                                            </td>
                                            <td style="padding:10px; border:1px solid #ddd;">Quick assembly with only a
                                                single wrench required; includes pole-mounting hardware.</td>
                                        </tr>
                                    </tbody>
                                    </tbody>
                                </table>
