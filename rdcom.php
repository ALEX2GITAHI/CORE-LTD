    ...
    <div class="container">
        <div class="breadcrumb-content">
            <ul>
                ...
                <li class="active">RDCOM Cat 6 Indoor Cable</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/rdcom.webp"
                                data-gall="myGallery">
                                <img src="images/product/small-size/rdcom.webp" alt="product image" />
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-7 col-md-6">
                <div class="product-details-view-content pt-60">
                    <div class="product-info">
                        <h4>
                            <a class="product_name">RDCOM Cat 6 Indoor Cable</a>
                        </h4>
                        ...
                        <div class="product-desc">
                            <p>
                                <span>
                                    <h4><b>Features: RDCOM Cat 6 Indoor Cable</b></h4>
                                    <ul>
                                        <li><b>High-Speed Performance:</b> Supports Gigabit Ethernet, ensuring efficient
                                            and reliable data transmission.</li>
                                        <li><b>Bandwidth Capacity:</b> Operates at a bandwidth of up to 100 MHz,
                                            suitable for various networking applications.</li>
                                        <li><b>Construction:</b> Unshielded Twisted Pair (UTP) design with 4 pairs,
                                            providing flexibility and ease of installation.</li>
                                        <li><b>Insulation:</b> Features PE (Polyethylene) insulation for enhanced signal
                                            integrity.</li>
                                        <li><b>Jacket Material:</b> Flame Retardant PVC (FR PVC) jacket, ensuring safety
                                            in indoor environments.</li>
                                        <li><b>Length:</b> Available in 305 meters (1000 feet) per roll, suitable for
                                            extensive cabling requirements.</li>
                                        <li><b>Applications:</b> Ideal for LAN networks, CCTV installations, and voice
                                            communication setups.</li>
                                    </ul>
                                </span>
                            </p>
                        </div>
