          ...
          <div class="product-details-images slider-navigation-1">
            <div class="lg-image">
              <a
                ...
                href="images/product/small-size/RB941-.webpg"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/RB941-.webp"
                  alt="product image" />
              </a>
            </div>
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/rb941 side.jpg"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/rb941 side.jpg"
                  alt="product image" />
              </a>
            </div>
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/rb941 side 2.jpg"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/rb941 side 2.jpg"
                  alt="product image" />
              </a>
            </div>  
            <div class="lg-image">
      ...
      <div class="col-lg-7 col-md-6">
        <div class="product-details-view-content pt-60">
          <div class="product-info">
            <h3>Mikrotik hAP Lite TC RB941-2nD-TC</h3>
