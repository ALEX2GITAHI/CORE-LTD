      ...
      <div class="col-lg-5 col-md-6">
        ...
        <div class="product-details-left">
          <div class="product-details-images slider-navigation-1">
            <div class="lg-image">
              <a
                ...
                href="images/product/small-size/tenda ac10.jpg"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/tenda ac10.jpg"
                  alt="product image" />
              </a>
            </div>
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/tenda ac10 all.jpg"
                data-gall="myGallery">
                <img
            ...
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/tenda ac10 3.jpg"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/tenda ac10 3.jpg"
                  alt="product image" />
              </a>
            </div>  
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/tenda ac10 2.jpg"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/tenda ac10 2.jpg"
                  alt="product image" />
              </a>
            </div>           
          </div>
          <div class="product-details-thumbs slider-thumbs-1">
            ...
            <div class="sm-image">
              <img
              src="images/product/small-size/tenda ac10 side.png"
              alt="product image thumb" />
            </div> 
          </div>
        </div>
      ...
      <div class="col-lg-7 col-md-6">
        <div class="product-details-view-content pt-60">
          <div class="product-info">
            <h3>Tenda AC10 V3 AC1200 Wireless Dual Band Wi-Fi Router</h3>
