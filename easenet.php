            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/easenet_1.png"
                                data-gall="myGallery">
                                <img src="images/product/small-size/easenet_1.png" alt="product image" />
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-desc">
                            <p>
                                <span>
                                    <ul>
                                        <li><b>High-Speed Data Transmission:</b> Supports up to 1 Gbps speeds with a 250
                                            MHz bandwidth for reliable performance.</li>
                                        <li><b>Pure Copper Conductors:</b> Ensures minimal signal loss and enhanced
                                            durability compared to CCA cables.</li>
                                        <li><b>Enhanced Shielding:</b> Reduces interference and crosstalk, providing
                                            stable network connections.</li>
                                        <li><b>Durable PVC Jacket:</b> Designed for indoor use with flexibility and
                                            resistance to wear and tear.</li>
                                        <li><b>Universal Compatibility:</b> Works with routers, switches, patch panels,
                                            and other networking devices.</li>
                                    </ul>
                                </span>
                            </p>
                        </div>
