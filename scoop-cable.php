    ...
    <div class="container">
        <div class="breadcrumb-content">
            <ul>
                ...
                <li class="active">Scoop Cat 6 Indoor Cable</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/scoop cable.webp"
                                data-gall="myGallery">
                                <img src="images/product/small-size/scoop cable.webp" alt="product image" />
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-7 col-md-6">
                <div class="product-details-view-content pt-60">
                    <div class="product-info">
                        <h4>
                            <a class="product_name">Scoop Cat 6 Indoor Cable</a>
                        </h4>
                        ...
                        <div class="product-desc">
                            <p>
                                <span>
                                    <h4><b>Features: Scoop Cat 6 Indoor Cable (UTP-6305C)</b></h4>
                                    <ul>
                                        <li><b>Category:</b> Cat6 Unshielded Twisted Pair (UTP)</li>
                                        <li><b>Conductor Material:</b> Copper-Clad Aluminium (CCA)</li>
                                        <li><b>Conductor Diameter:</b> 0.56mm (23 AWG)</li>
                                        <li><b>Length:</b> 305 meters (1000 feet)</li>
                                        <li><b>Outer Jacket:</b> Durable PVC in Grey</li>
                                        <li><b>Cross Filler:</b> Included for enhanced signal separation</li>
                                        <li><b>Pairs:</b> 4 twisted pairs</li>
                                        <li><b>ESD Drain Wire:</b> None</li>
                                        <li><b>Packaging:</b> Supplied in an easy-pull box for convenient installation
                                        </li>
                                        <li><b>Applications:</b> Suitable for Ethernet and general networking
                                            installations</li>
                                    </ul>
                                </span>
                            </p>
