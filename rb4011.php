    ...
    <div class="container">
        <div class="breadcrumb-content">
            <ul>
                ...
                <li class="active">MikroTik RB4011iGS+RM Ethernet Router</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/rb40ll 1.png"
                                data-gall="myGallery">
                                <img src="images/product/small-size/rb40ll 1.png" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/rb40ll  2.jpg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/rb40ll  2.jpg" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/rb40ll 3.jpg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/rb40ll 3.jpg" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/rb40ll  2.jpg"
                    ...
                    <div class="product-details-thumbs slider-thumbs-1">
                        <div class="sm-image">
                            <img src="images/product/small-size/rb40ll 1.png" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/rb40ll  2.jpg" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/rb40ll 3.jpg" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/rb40ll  2.jpg" alt="product image thumb" />
                        </div>
            ...
            <div class="col-lg-7 col-md-6">
                <div class="product-details-view-content pt-60">
                    <div class="product-info">
                        <h4>
                            <a class="product_name">MikroTik RB4011iGS+RM Ethernet Router</a>
                        </h4>
                        ...
                        <div class="price-box pt-20">
                            <span class="new-price new-price-2">Ksh. 26,000</span>
                        </div>
