    ...
    <div class="container-fluid">
        <div class="breadcrumb-content">
            <ul>
                ...
                <li class="active">Drop Cable 1KM 8 Core</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/drop 1km 8core.jpg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/drop 1km 8core.jpg" alt="product image" />
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-7 col-md-6">
                <div class="product-details-view-content pt-60">
                    <div class="product-info">
                        <h4>
                            <a class="product_name">Drop Cable 1KM 8 Core</a>
                        </h4>
                        ...
                        <div class="product-desc">
                            <div style="overflow-x:auto;">
                                <h4><b>Features: Drop Cable 1KM 8 Core</b></h4>
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding:10px; border:1px solid #ddd;">Ideal for FTTH deployments,
                                                distribution networks, estates, and multi-user connections.</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="padding:10px; border:1px solid #ddd;">Reinforced with steel wire
                                                / FRP for superior tensile strength and durability.</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <!-- Hidden Rows -->
                                    <tbody id="more-drop-8core" style="display: none;">
                                        <tr>
                                            ...
                                            <td style="padding:10px; border:1px solid #ddd;">UV-resistant LSZH / PE
                                                sheath suitable for outdoor and indoor use.</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding:10px; border:1px solid #ddd;">Designed to withstand UV
                                                exposure, rain, and harsh environmental conditions.</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding:10px; border:1px solid #ddd;">Lightweight and flexible
                                                design allows easy routing and deployment in various environments.</td>
                                        </tr>
                                    </tbody>
                                    </tbody>
                                </table>
                                ...
                                <div style="text-align:center; margin-top:10px;">
                                    <button onclick="toggleDrop8Core()"
                            ...
                            <!-- Script -->
                            <script>
                                function toggleDrop8Core() {
                                    var hiddenRows = document.getElementById("more-drop-8core");
                                    var button = document.getElementById("drop8coreBtn");
