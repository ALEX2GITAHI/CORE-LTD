    ...
    <div class="container-fluid">
        <div class="breadcrumb-content">
            <ul>
                ...
                <li class="active">Tenda OAP1200</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/tenda-aop-box.jpeg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/tenda-aop-box.jpeg" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/tenda-aop-side.jpg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/tenda-aop-side.jpg" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/tenda-aop-front.png"
                                data-gall="myGallery">
                                <img src="images/product/small-size/tenda-aop-front.png" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/tenda-aop-box.jpeg"
                    ...
                    <div class="product-details-thumbs slider-thumbs-1">
                        <div class="sm-image">
                            <img src="images/product/small-size/tenda-aop-box.jpeg" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/tenda-aop-side.jpg" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/tenda-aop-front.png" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/tenda-aop-box.jpeg" alt="product image thumb" />
                        </div>
