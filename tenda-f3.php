                ...
                <div class="product-details-images slider-navigation-1">
                  <div class="lg-image">
                    <a
                      ...
                      href="images/product/small-size/Tenda F3.jpg"
                      data-gall="myGallery"
                    >
                      <img
                  ...
                  <div class="lg-image">
                    <a
                      class="popup-img venobox vbox-item"
                      href="images/product/small-size/tenda f3 front.jpg"
                      data-gall="myGallery"
                    >
                      <img
                        src="images/product/small-size/tenda f3 front.jpg"
                        alt="product image"
                      />
                    </a>
                  </div>
                  <div class="lg-image">
                    <a
                      class="popup-img venobox vbox-item"
                      href="images/product/small-size/tenda f3 side.jpg"
                      data-gall="myGallery"
                    >
                      <img
                        src="images/product/small-size/tenda f3 side.jpg"
                        alt="product image"
                      />
                    </a>
                  </div>
                  <div class="lg-image">
                    <a
                      class="popup-img venobox vbox-item"
                      href="images/product/small-size/tenda f3 back.jpg"
                      data-gall="myGallery"
                    >
                      <img
                        src="images/product/small-size/tenda f3 back.jpg"
                        alt="product image"
                      />
                    </a>
                  </div>
                  <div class="lg-image">
                    <a
                      class="popup-img venobox vbox-item"
                      href="images/product/small-size/tenda f3 all.jpg"
                      data-gall="myGallery"
                    >
                      <img
                        src="images/product/small-size/tenda f3 all.jpg"
                        alt="product image"
                      />
                    </a>
                  </div>                  
                ...
                <div class="product-info">
                  ...
                  <div class="product-additional-info pt-25">
                    <a class="wishlist-btn" href="wishlist.html"
                      ><i class="fab fa-heart-o"></i>Add to wishlist</a
                    >
                    ...
                    <div class="single-product-wrap">
                      ...
                      <div class="product_desc">
                        <div class="product_desc_info">
                          ...
                          <h4>
                            <a class="product_name" href="tenda-f6.php"
                              >Tenda-F6</a
                            >
                          </h4>
                          <div class="price-box">
                            <span class="new-price">Ksh. 1,650</span>
                          </div>
                        </div>
                    ...
                    <div class="single-product-wrap">
                      ...
                      <div class="product_desc">
                        <div class="product_desc_info">
                          ...
                          <h4>
                            <a class="product_name" href="tenda-ac5.php"
                              >Tenda AC5</a
                            >
                          </h4>
                          <div class="price-box">
                    ...
                    <div class="single-product-wrap">
                      ...
                      <div class="product_desc">
                        <div class="product_desc_info">
                          ...
                          <h4>
                            <a class="product_name" href="tenda-ac10.php"
                              >Tenda-AC10</a
                            >
                          </h4>
                          <div class="price-box">
                    ...
                    <div class="single-product-wrap">
                      ...
                      <div class="product_desc">
                        <div class="product_desc_info">
                          ...
                          <h4>
                            <a class="product_name" href="tp-link-840.php"
                              >TP-Link 840N</a
                            >
                          </h4>
                          <div class="price-box">
                    ...
                    <div class="single-product-wrap">
                      ...
                      <div class="product_desc">
                        <div class="product_desc_info">
                          ...
                          <h4>
                            <a class="product_name" href="tp-link-844.php"
                              >TP-Link 844N</a
                            >
                          </h4>
                          <div class="price-box">
