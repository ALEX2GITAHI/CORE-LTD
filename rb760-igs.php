          ...
          <div class="product-details-images slider-navigation-1">
            <div class="lg-image">
              <a
                ...
                href="images/product/small-size/rb760igs 1.webp"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/rb760igs 1.webp"
                  alt="product image" />
              </a>
            </div>
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/rb760igs 2.jpg"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/rb760igs 2.jpg"
                  alt="product image" />
              </a>
            </div>
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/rb760igs 3.webp"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/rb760igs 3.webp"
                  alt="product image" />
              </a>
            </div>  
            <div class="lg-image">
      ...
      <div class="col-lg-7 col-md-6">
        <div class="product-details-view-content pt-60">
          <div class="product-info">
            <h3>Mikrotik RB760iGS hEX S 5x Gigabit Ethernet SFP Dual Core 880MHz CPU</h3>
