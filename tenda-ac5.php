            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/tenda ac5 aall.webp"
                                data-gall="myGallery">
                                <img src="images/product/small-size/tenda ac5 aall.webp" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/tenda ac5 back.webp"
                                data-gall="myGallery">
                                <img src="images/product/small-size/tenda ac5 back.webp" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/Tenda-AC5-front.jpg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/Tenda-AC5-front.jpg" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/tenda ac5 back.jpg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/tenda ac5 back.jpg" alt="product image" />
                            </a>
                        </div>
                    </div>
                    <div class="product-details-thumbs slider-thumbs-1">
                        <div class="sm-image">
                            <img src="images/product/small-size/tenda ac5 aall.webp" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/tenda ac5 back.webp" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/Tenda-AC5-front.jpg" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/tenda ac5 back.jpg" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/tenda ac5 back.jpg" alt="product image thumb" />
                        </div>
            ...
            <div class="col-lg-7 col-md-6">
                <div class="product-details-view-content pt-60">
                    <div class="product-info">
                        <h4>
                            <a class="product_name">Tenda AC5 V3 AC1200 Wireless Dual Band Wi-Fi Router</a>
                        </h4>
