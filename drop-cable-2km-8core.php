    ...
    <div class="container-fluid">
        <div class="breadcrumb-content">
            <ul>
                ...
                <li class="active">Drop Cable 2KM 8 Core</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/drop 2km 8core.avif"
                                data-gall="myGallery">
                                <img src="images/product/small-size/drop 2km 8core.avif" alt="product image" />
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-7 col-md-6">
                <div class="product-details-view-content pt-60">
                    <div class="product-info">
                        <h4>
                            <a class="product_name">Drop Cable 2KM 8 Core</a>
                        </h4>
                        ...
                        <div class="price-box">
                            <span class="new-price">Ksh. 20,800</span>
                        </div>
                        <div class="product-desc">
                            <div style="overflow-x:auto;">
                                <h4><b>Features: Drop Cable 2KM 8 Core</b></h4>
                                <table
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="padding:10px; border:1px solid #ddd;">8 Core Fiber Optic Drop
                                                Cable (FTTH)</td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;"><b>Fiber Count</b></td>
                                            <td style="padding:10px; border:1px solid #ddd;">8 Fibers (Single Mode)</td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;"><b>Application</b></td>
                                            <td style="padding:10px; border:1px solid #ddd;">Ideal for long-distance
                                                FTTH deployments, estates, campuses, and high-density distribution
                                                networks.</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="padding:10px; border:1px solid #ddd;">Reinforced with steel wire
                                                / FRP for superior tensile strength and durability over extended runs.
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <!-- Hidden Rows -->
                                    <tbody id="more-drop-2km-8core" style="display: none;">
                                        <tr>
                                            ...
                                            <td style="padding:10px; border:1px solid #ddd;">UV-resistant LSZH / PE
                                                sheath suitable for indoor and outdoor installations.</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding:10px; border:1px solid #ddd;">Designed to withstand UV
                                                exposure, rain, wind, and harsh outdoor conditions.</td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;"><b>Low Signal
                                                    Attenuation</b></td>
                                            <td style="padding:10px; border:1px solid #ddd;">Ensures efficient,
                                                high-speed data transmission over long distances.</td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;"><b>Flexible & Easy
                                                    Installation</b></td>
                                            <td style="padding:10px; border:1px solid #ddd;">Lightweight and flexible
                                                design allows easy routing across long spans and complex layouts.</td>
                                        </tr>
                                    </tbody>
                                    </tbody>
                                </table>
                                ...
                                <div style="text-align:center; margin-top:10px;">
                                    <button onclick="toggleDrop2KM8Core()"
                            ...
                            <!-- Script -->
                            <script>
                                function toggleDrop2KM8Core() {
                                    var hiddenRows = document.getElementById("more-drop-2km-8core");
                                    var button = document.getElementById("drop2km8coreBtn");
