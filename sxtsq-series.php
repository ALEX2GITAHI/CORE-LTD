          ...
          <div class="product-details-images slider-navigation-1">
            <div class="lg-image">
              <a
                ...
                href="images/product/small-size/sxtsq 2.jpg"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/sxtsq 2.jpg"
                  alt="product image" />
              </a>
            </div>
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/SXTSQ- 4.webp"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/SXTSQ- 4.webp"
                  alt="product image" />
              </a>
            </div>
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/sxtsq 3.png"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/sxtsq 3.png"
                  alt="product image" />
              </a>
            </div>  
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/sxtsq 1.jpg"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/sxtsq 1.jpg"
                  alt="product image" />
              </a>
            </div>           
          </div>
