    ...
    <div class="container-fluid">
        <div class="breadcrumb-content">
            <ul>
                ...
                <li class="active">Drop Cable 2KM 2 Core</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/drop 2km.jpg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/drop 2km.jpg" alt="product image" />
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-7 col-md-6">
                <div class="product-details-view-content pt-60">
                    <div class="product-info">
                        <h4>
                            <a class="product_name">Drop Cable 2KM 2 Core</a>
                        </h4>
                        ...
                        <div class="product-desc">
                            <div style="overflow-x:auto;">
                                <h4><b>Features: Drop Cable 2KM 2 Core</b></h4>
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding:10px; border:1px solid #ddd;">Ideal for long-distance
                                                FTTH connections, last-mile links, and rural or estate deployments.</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="padding:10px; border:1px solid #ddd;">Reinforced with steel wire
                                                / FRP for enhanced tensile strength over longer distances.</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <!-- Hidden Rows -->
                                    <tbody id="more-drop-2km-2core" style="display: none;">
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding:10px; border:1px solid #ddd;">Lightweight and flexible
                                                for easy routing across long spans and complex layouts.</td>
                                        </tr>
                                    </tbody>
                                    </tbody>
                                </table>
                                ...
                                <div style="text-align:center; margin-top:10px;">
                                    <button onclick="toggleDrop2KM2Core()"
                            ...
                            <!-- Script -->
                            <script>
                                function toggleDrop2KM2Core() {
                                    var hiddenRows = document.getElementById("more-drop-2km-2core");
                                    var button = document.getElementById("drop2km2coreBtn");
