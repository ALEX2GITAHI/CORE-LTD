          ...
          <div class="product-details-images slider-navigation-1">
            <div class="lg-image">
              <a
                ...
                href="images/product/small-size/rb951 all.jpg"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/rb951 all.jpg"
                  alt="product image" />
              </a>
            </div>
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/rb951 side.png"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/rb951 side.png"
                  alt="product image" />
              </a>
            </div>
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/rb951 front.webp"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/rb951 front.webp"
                  alt="product image" />
              </a>
            </div>  
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/rb951 back.jpg"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/rb951 back.jpg"
                  alt="product image" />
              </a>
            </div>           
          </div>
      ...
      <div class="col-lg-7 col-md-6">
        <div class="product-details-view-content pt-60">
          <div class="product-info">
            <h3>Mikrotik RB951Ui-2HnD Router</h3>
            ...
            <div class="product-desc">
              <p>
                <span>
                  <ul>
                    <li><b>600 MHz CPU:</b>Efficient processing power for smooth network performance.</li>
                    <li><b>5 Gigabit Ethernet Ports:</b>Provides high-speed, stable wired connections for multiple devices.</li>
                    <li><b>Robust Security:</b>Includes strong encryption and access control for a secure network.</li>
                    <li><b>RouterOS Support:</b>Advanced network management with firewall, VPN, and traffic control features.)</li>
