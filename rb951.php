    ...
    <div class="container">
        <div class="breadcrumb-content">
            <ul>
                ...
                <li class="active">Mikrotik RB951Ui-2HnD Router</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/rb951 all.jpg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/rb951 all.jpg" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/rb951 side.png"
                                data-gall="myGallery">
                                <img src="images/product/small-size/rb951 side.png" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/rb951 front.webp"
                                data-gall="myGallery">
                                <img src="images/product/small-size/rb951 front.webp" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/rb951 back.jpg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/rb951 back.jpg" alt="product image" />
                            </a>
                        </div>
                    </div>
                    <div class="product-details-thumbs slider-thumbs-1">
                        <div class="sm-image">
                            <img src="images/product/small-size/rb951 all.jpg" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/rb951 side.png" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/rb951 front.webp" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/rb951 all.jpg" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/rb951 back.jpg" alt="product image thumb" />
                        </div>
                    </div>
                </div>
                <!--// Product Details Left -->
            ...
            <div class="col-lg-7 col-md-6">
                <div class="product-details-view-content pt-60">
                    <div class="product-info">
                        <h4>
                            <a class="product_name">Mikrotik RB951Ui-2HnD Router</a>
                        </h4>
