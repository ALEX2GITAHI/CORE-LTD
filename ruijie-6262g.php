    ...
    <div class="container-fluid">
        <div class="breadcrumb-content">
            <ul>
                ...
                <li class="active">Ruijie 6262G</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/ruijie-front.jpg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/ruijie-front.jpg" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/ruijie-right.jpg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/ruijie-right.jpg" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/ruijie-back.jpg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/ruijie-back.jpg" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/ruijie-side.jpg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/ruijie-side.jpg" alt="product image" />
                            </a>
                        </div>
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/ruijie-mount.jpg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/ruijie-mount.jpg" alt="product image" />
                            </a>
                        </div>
                    </div>
                    <div class="product-details-thumbs slider-thumbs-1">
                        <div class="sm-image">
                            <img src="images/product/small-size/ruijie-front.jpg" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/ruijie-right.jpg" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/ruijie-back.jpg" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/ruijie-side.jpg" alt="product image thumb" />
                        </div>
                        <div class="sm-image">
                            <img src="images/product/small-size/ruijie-mount.jpg" alt="product image thumb" />
                        </div>
                    </div>
                </div>
                <!--// Product Details Left -->
            ...
            <div class="col-lg-7 col-md-6">
                <div class="product-details-view-content pt-60">
                    <div class="product-info">
                        <h4>
                            <a class="product_name">Ruijie Reyee RG‑RAP6262(G) Outdoor AP</a>
                        </h4>

                        <span class="product-details-ref">Reference: 6262G</span>
                        ...
                        <div class="price-box pt-20">
                            <span class="new-price new-price-2">Ksh. 25,000</span>
                        </div>
