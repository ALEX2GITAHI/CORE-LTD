          ...
          <div class="product-details-images slider-navigation-1">
            <div class="lg-image">
              <a
                ...
                href="images/product/small-size/tenda ac8.jpg"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/tenda ac8.jpg"
                  alt="product image" />
              </a>
            </div>
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/tenda ac 8 front.jpg"
                data-gall="myGallery">
                <img
            ...
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/tenda ac8 back.jpg"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/tenda ac8 back.jpg"
                  alt="product image" />
              </a>
            </div>  
            <div class="lg-image">
              <a
                class="popup-img venobox vbox-item"
                href="images/product/small-size/tenda ac8 all.jpg"
                data-gall="myGallery">
                <img
                  src="images/product/small-size/tenda ac8 all.jpg"
                  alt="product image" />
              </a>
            </div>           
          </div>
      ...
      <div class="col-lg-7 col-md-6">
        <div class="product-details-view-content pt-60">
          <div class="product-info">
            <h3>Tenda AC8 V3 AC1200 Wireless Dual Band Wi-Fi Router</h3>
