    ...
    <div class="container-fluid">
        <div class="breadcrumb-content">
            <ul>
                ...
                <li class="active">Drop Cable 2KM 4 Core</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-5 col-md-6">
                ...
                <div class="product-details-left">
                    <div class="product-details-images slider-navigation-1">
                        <div class="lg-image">
                            <a class="popup-img venobox vbox-item" href="images/product/small-size/drop 2km 4core.jpg"
                                data-gall="myGallery">
                                <img src="images/product/small-size/drop 2km 4core.jpg" alt="product image" />
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-7 col-md-6">
                <div class="product-details-view-content pt-60">
                    <div class="product-info">
                        <h4>
                            <a class="product_name">Drop Cable 2KM 4 Core</a>
                        </h4>
                        ...
                        <div class="price-box">
                            <span class="new-price">Ksh. 15,800</span>
                        </div>
                        <div class="product-desc">
                            <div style="overflow-x:auto;">
                                <h4><b>Features: Drop Cable 2KM 4 Core</b></h4>
                                <table
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;"><b>Cable
                                                    Type</b></td>
                                            <td style="padding:10px; border:1px solid #ddd;">4 Core
                                                Fiber Optic Drop Cable (FTTH)</td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;"><b>Fiber
                                                    Count</b></td>
                                            <td style="padding:10px; border:1px solid #ddd;">4 Fibers
                                                (Single Mode)</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="padding:10px; border:1px solid #ddd;">Ideal for
                                                long-distance FTTH deployments, estates, and multi-user
                                                distribution networks.</td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;"><b>Strength
                                                    Member</b></td>
                                            <td style="padding:10px; border:1px solid #ddd;">Reinforced
                                                with steel wire / FRP for enhanced durability and
                                                tensile strength over long runs.</td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;">
                                                <b>Length</b>
                                            </td>
                                            <td style="padding:10px; border:1px solid #ddd;">2000 Meters
                                                (2KM Roll)</td>
                                        </tr>

                                        <!-- Hidden Rows -->
                                    <tbody id="more-drop-2km-4core" style="display: none;">
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;"><b>Outer
                                                    Jacket</b></td>
                                            <td style="padding:10px; border:1px solid #ddd;">
                                                UV-resistant LSZH / PE sheath suitable for outdoor and
                                                indoor use.</td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;">
                                            ...
                                            <td style="padding:10px; border:1px solid #ddd;">Supports
                                                aerial, duct, and wall-mounted installations.</td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;"><b>Weather
                                                    Resistance</b></td>
                                            <td style="padding:10px; border:1px solid #ddd;">Designed to
                                                withstand harsh outdoor conditions including UV
                                                exposure, rain, and wind.</td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;"><b>Low
                                                    Signal Attenuation</b></td>
                                            <td style="padding:10px; border:1px solid #ddd;">Ensures
                                                stable, high-speed data transmission over extended
                                                distances.</td>
                                        </tr>
                                        <tr>
                                            <td style="padding:10px; border:1px solid #ddd;"><b>Flexible
                                                    & Easy Installation</b></td>
                                            <td style="padding:10px; border:1px solid #ddd;">Lightweight
                                                and flexible design allows easy routing across long
                                                spans and complex layouts.</td>
                                        </tr>
                                    </tbody>
                                    </tbody>
                                </table>
                                ...
                                <div style="text-align:center; margin-top:10px;">
                                    <button onclick="toggleDrop2KM4Core()"
                            ...
                            <!-- Script -->
                            <script>
                                function toggleDrop2KM4Core() {
                                    var hiddenRows = document.getElementById("more-drop-2km-4core");
                                    var button = document.getElementById("drop2km4coreBtn");
                                ...
                                <script>
                                    document.addEventListener("DOMContentLoaded", function() {
                                        ...
                                        const productName = document.querySelector(".product_name")?.textContent
                                            .trim() || "this product";
                                        const productPrice = document.querySelector(".new-price")?.textContent
                                            .trim() ||
                                            "";
